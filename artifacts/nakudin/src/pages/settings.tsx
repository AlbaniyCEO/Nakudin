...
import { ChevronRight, User, CreditCard, LogOut, Shield } from "lucide-react";
...
function SettingsRow({ icon: Icon, label, description, onClick, href, destructive }: SettingsRowProps) {
  const inner = (
    <div
  ...
  return (
    <div className="px-4 py-4 pb-24 max-w-lg mx-auto" data-testid="page-settings">
      ...
      <div className="bg-card border border-card-border rounded-xl px-4 mb-4">
        <SettingsRow icon={User} label="Edit Shop Profile" description="Change name, bio, logo" href="/dashboard" />
        <SettingsRow icon={CreditCard} label="Subscription & Billing" description="Manage your plan" href="/subscription" />
